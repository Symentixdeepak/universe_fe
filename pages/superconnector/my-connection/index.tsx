...
function SuperconnectorMyConnectionPage() {
  return (
    <>
      <Head>
...
(SuperconnectorMyConnectionPage as any).getLayout = function getLayout(
  page: ReactElement
) {
  return (
    <ProtectedRoute
...
export default SuperconnectorMyConnectionPage;