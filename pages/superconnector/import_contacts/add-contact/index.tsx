...
const AddContact = createAsyncComponent(
  () => import("@/features/SuperConnector/Contacts/AddContact"),
  LoaderConfigs.page
);

function AddContacts() {
  console.log("AddContacts component rendered");
  return (
    <>
      <Head>
        <title>Add Contact - Universe Club</title>
      </Head>
      <AddContact />
    </>
  );
...
(AddContacts as any).getLayout = function getLayout(page: ReactElement) {
